...
public class SpectrogramHelper
{
    ...
    int targetHeight)
    {
        ...
        {
            sliceImage.Resize(sliceWidth, targetHeight, Godot.Image.Interpolation.Trilinear);
        }
    ...
    public static SpectrogramGenerator GetSpectrogramGenerator_ByWidth(PcmData pcmData, int targetWidthPixels = 3000, int fftSize = 16384, int maxFreq = 2200, double multiplier = 16_000)
    {
        ...
        return GetSpectrogramGenerator(pcmData, fftSize, maxFreq, multiplier, stepSize);
    }

    /// <summary>
    /// Generate SpectrogramGenerator from AudioFile with known stepSize.
    /// </summary>
    public static SpectrogramGenerator GetSpectrogramGenerator(PcmData pcmData, int fftSize = 16384, int maxFreq = 20000, double multiplier = 16_000, int stepSize = 1)
    {
